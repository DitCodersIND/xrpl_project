...
<body>
  ...
  <section id="jb">
    <div class="bg-primary text-center text-light p-3 jumbotron jumbotron-fluid">
      ...
      <h1  class="display-4 fw-bold">Welcome <?php echo $_SESSION["usrna"]; ?></h1>
  ...
  <section id="main">
    <div class="container-fluid text-center" data-aos="fade-up">
      <div class=" container shadow p-3 mb-5 bg-body rounded m-9">
        ...
        <hr>
        <p class="card-text">Selamat datang di halaman website
        aplikasi milik siswa X RPL SMK BATIK PERBAIK PPURWREJO.Website inj
        berisi beberapa informasi dan profil siswa kelas X RPL</p>
      </div>
    </div>
